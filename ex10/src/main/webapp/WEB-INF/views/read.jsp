	...
	<form name="frm" action="update" method="post" enctype="multipart/form-data">
		...
		<table border=1>
			<tr>
				...
				<td width=500><input type="text" name="pname" size=50
					value="${vo.pname}"></td>
			</tr>
			<tr>
				<td width=100>상품가격</td>
				<td width=500><input type="text" name="price" size=5
					value="${vo.price}">원</td>
			</tr>
			<tr>
				<td width=100>대표이미지</td>
				<td width=500><img src="display?fileName=${vo.image}"
					id="image" width=150> <input type="file" name="file">
				</td>
			</tr>
			<tr>
				<td width=100 height=180><input type="button" id="btnImage"
					value="첨부이미지"></td>
